...
| ----------------------------------------------------- | -------------------------- | ------ | ---------- | ----------------------------------------------------------------------------------- |
| Other app connects to localhost server                | **Spoofing**               | Medium | Low        | localhost-only binding, plus a connection token required on every request           |
...
| Connection token            | Required on every request but `/version`. Generated by the server, kept in app-private storage, owner-readable only |
